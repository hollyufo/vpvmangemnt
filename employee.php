                  ...
                  <div class="table-responsive"> 
                    <table class="table">
                      ...
                      <?php 
                          ...
                          while($expence = mysqli_fetch_assoc($result1p)) {
                              ...
                              <div role="document" class="modal-dialog">
                                <div class="modal-content">
                                  ...
                                  <p>Are you sure u want to DELETE '.$expence['fname'].'.</p>
                                  </div>
                                  <div class="modal-footer">
                                    <button type="button" data-dismiss="modal" class="btn btn-secondary">Close</button>
                                    <a href="./removeemployee.php?id='.$expence['expenceid'].'" type="button" class="btn btn-danger">DELETE</a>
                                  </div>
                                </div>
                              </div>
                            </div>
                          ...
                          if(isset($_GET['user'])){
                              echo '<div class="alert alert-success" role="alert">'.$_GET['user'].' was added successfully</div>';
                          }elseif (isset($_GET['deleted'])) {
                              echo '<div class="alert alert-danger" role="alert">Expence was deleted successfully</div>';
                          }elseif(isset($_GET['updated'])){
                              echo '<div class="alert alert-info" role="alert"> Changes to'.$_GET['updated'].' are saved successfully</div>';
                          }
                      ?>
                              </tbody>
                    </table>
