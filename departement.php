                ...
                <div class="block margin-bottom-sm">
                  ...
                  <div class="table-responsive"> 
                    <table class="table">
                      ...
                      <?php
                                // show data
                                $sql = "SELECT * FROM employee INNER join dep on employee.depid = dep.depid INNER JOIN payroll on payroll.empolyeeid = employee.employeeid";
                      ...
                      <div role="document" class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <form method="POST">
                              ...
                              <div class="form-group">       
                                  <input type="submit" name="departement" value="departement" class="btn btn-primary">
                              </div>
                          </form>
                          </div>
