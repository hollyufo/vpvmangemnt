    ...
    <div class="col-lg-4">
        <div class="block">
          ...
          <div class="block-body text-center">
            <button type="button" data-toggle="modal" data-target="#myModal" class="btn btn-primary">ADD Departement</button>
            <!-- Modal-->
            <div id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
              <div role="document" class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header"><strong id="exampleModalLabel" class="modal-title">Add a Departement</strong>
                  ...
                  <div class="modal-body">
                    ...
                    <form>
                      <div class="form-group">
                        <label>name</label>
                        <input type="text" placeholder="Departement name" class="form-control">
                      </div>
                      <div class="form-group">       
