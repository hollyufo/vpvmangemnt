                  ...
                  <div class="modal-body">
                    ...
                    <form>
                        <div class="form-group">
                            ...
                            <input name="ename" type="text" placeholder="Enter the expence name" class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Select type of Expence</label>
                            <select class="form-select bg-dark text1 aria-label=" Default select example name="etype">
