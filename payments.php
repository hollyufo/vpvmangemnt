            ...
            <div id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
              <div role="document" class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header"><strong id="exampleModalLabel" class="modal-title">Add a Payment</strong>
                  ...
                  <div class="modal-body">
                    ...
                    <form>
                        <div class="form-group">
                            <label>Amount</label>
                            <input type="number" placeholder="Amount of payment" name="amount" class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Date</label>
                        ...
                        <div class="form-group">       
                            ...
                            <input type="text" placeholder="Enter Refrence" name="refrence" class="form-control">
                        </div>
                        <div class="form-group">       
